...
class NightFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        view.findViewById<ImageView>(R.id.imageView).setImageDrawable(ContextCompat.getDrawable(view.context,R.drawable.image_000))
        view.findViewById<TextView>(R.id.pageTitle).text = arguments?.getString("PAGE_TITLE") ?: "PAGE"
        view.findViewById<TextView>(R.id.pageDescription).text = getString(R.string.night_wiki)
    }
